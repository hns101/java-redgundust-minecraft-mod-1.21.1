package net.rubberduck.redgundust;
...
@Mod(RedGunDust.MOD_ID)
public class RedGunDust {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "redgundust";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();

    public RedGunDust(FMLJavaModLoadingContext context) {
